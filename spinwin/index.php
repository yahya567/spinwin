...
<html>
  <head>
    ...
    <style>
      ...
      .navbar {
        background: linear-gradient(45deg, #2a0000, #5a0000) !important;
      ...
      .alert-warning {
        background: rgba(90, 0, 0, 0.8) !important;
        border: 2px solid #ffd700;
        color: #fff !important;
      }
      ...
      /* Add some casino pattern to the background */
      body::before {
        content: "";
        position: fixed;
        top: 0;
        ...
        opacity: 0.1;
        z-index: -1;
        background-image: url("data:image/svg+xml,%3Csvg width='52' height='26' viewBox='0 0 52 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffd700' fill-opacity='0.4'%3E%3Cpath d='M10 10c0-2.21-1.79-4-4-4-3.314 0-6-2.686-6-6h2c0 2.21 1.79 4 4 4 3.314 0 6 2.686 6 6 0 2.21 1.79 4 4 4 3.314 0 6 2.686 6 6 0 2.21 1.79 4 4 4v2c-3.314 0-6-2.686-6-6 0-2.21-1.79-4-4-4-3.314 0-6-2.686-6-6zm25.464-1.95l8.486 8.486-1.414 1.414-8.486-8.486 1.414-1.414z' /%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
      }
      ...
      /* Add some card symbols as decorative elements */
      .decorative-symbol::before {
        content: "♠ ♥ ♣ ♦";
        position: absolute;
        opacity: 0.1;
        font-size: 2rem;
    ...
    <!-- Update your Google Fonts link to include casino-style fonts -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" />
    <link href="https://fonts.googleapis.com/css2?family=Audiowide&family=Chakra+Petch:wght@400;700&display=swap" rel="stylesheet">
  </head>
  ...
  <a class="navbar-brand" href="#" onclick="showTab('#nav-home', this)">
    <i class="fas fa-dice"></i> SpinWin
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarTabs">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-dark">
          ...
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-my-lotto', this)">
            <i class="fas fa-clipboard-list mr-2"></i>My Lottos
          </a>
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-lotto-winners', this)">
            <i class="fas fa-trophy mr-2"></i>Lotto Winners
          </a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-dark">
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-buy', this)">
            <i class="fas fa-coins mr-2"></i>Purchase Coins
          </a>
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-withdraw', this)">
            <i class="fas fa-hand-holding-usd mr-2"></i>Withdraw
          </a>
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-transfer', this)">
      ...
      <!-- History Dropdown -->
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="historyDropdown" role="button" data-toggle="dropdown">
          <i class="fas fa-history"></i> History
        </a>
        <div class="dropdown-menu bg-dark">
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-orders', this)">
            <i class="fas fa-shopping-cart mr-2"></i>Orders
          </a>
          <a class="dropdown-item text-white" href="#" onclick="showTab('#nav-trxs', this)">
...
<!-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <script>
      ...
      document.addEventListener('click', function(event) {
        const navbar = document.getElementById('navbarTabs');
        const isClickInsideNavbar = event.target.closest('.navbar');

        // Only close if clicking outside navbar and it's currently open
      ...
      function showTab(tabId, element) {
        ...
        // Add active class to parent dropdown if exists
        const parentDropdown = element.closest('.dropdown-menu');
        if (parentDropdown) {
